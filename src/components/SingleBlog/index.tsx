  ...
  return (
    <div className='flex-5'>
        <div className='flex flex-col gap-3 max-md:text-sm'>
            ...
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Incidunt nisi quasi, quo culpa repellendus consectetur corporis recusandae accusamus fugit numquam cumque voluptatem libero aliquam odit nam porro illo! Ipsum vero ducimus temporibus, at dolor a expedita possimus odio voluptate! Accusamus.</p>
