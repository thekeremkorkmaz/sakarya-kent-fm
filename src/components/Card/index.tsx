  ...
  return (
    <div key={item.id} className='flex items-center gap-4 max-md:gap-3 max-md:flex-col max-md:items-start'>
      <div className='md:flex-1 md:w-[500px] max-md:text-left max-md:w-full'>
        <Image className='w-[400px] h-[300px] object-cover max-md:w-[150px] max-md:h-[150px] max-md:rounded-[50%]' src={item.img ? item.img : `/p1.jpeg`} height={300} width={300} alt='cate' />
      </div>
      <div className='md:flex-1 max-md:gap-1 flex flex-col md:h-[300px] justify-around'>
        ...
        <p className='opacity-80 max-xl:text-sm max-md:text-xs'>{`${textContent.substring(0, 100)}...`}</p>
